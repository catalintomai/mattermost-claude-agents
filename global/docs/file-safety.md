...
1. **Check method receivers**: Methods on a parent package type CANNOT be moved to subpackages — Go requires the method receiver to be defined in the same package as the type
