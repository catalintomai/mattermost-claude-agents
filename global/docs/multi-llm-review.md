...
**Note**: This exception applies ONLY to multi-LLM review tools (codex, gemini, cursor agent). For everything else (filesystem, GitHub, Jira), prefer MCP tools — see `%%MM_ROOT_DIR%%/CLAUDE.md`.
